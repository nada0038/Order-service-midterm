...
const RABBITMQ_CONNECTION_STRING = process.env.RABBITMQ_CONNECTION_STRING || 'amqp://40.125.45.182';  // Fallback to localhost if not defined
...
app.listen(PORT, '0.0.0.0', () => {
  console.log(`Order service is running on http://20.228.110.184:${PORT}`);
});